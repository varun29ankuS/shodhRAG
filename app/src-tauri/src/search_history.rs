...
impl SearchHistoryManager {
    ...
    pub fn add_search(&mut self, query: String, space_id: Option<String>, result_count: usize) -> Result<(), String> {
    ...
    pub fn get_suggestions(&self, query: &str, space_id: Option<&str>, limit: usize) -> Vec<SearchSuggestion> {
    ...
    fn load_history(&mut self) -> Result<(), String> {
        ...
        self.history = data.history.into_iter()
